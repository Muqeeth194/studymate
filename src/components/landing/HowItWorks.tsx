const steps = [
    {
      ...
      description: "Tell us what you want to learn, your skill level, and your goals.",
    },
    {
      step: 2,
      title: "Get Your Custom Roadmap",
      description: "Our AI generates a unique week-by-week learning plan just for you.",
    },
    {
      step: 3,
      title: "Learn & Interact",
      description: "Follow your plan, take adaptive quizzes, and chat with your AI tutor.",
    },
    {
      step: 4,
      title: "Track Your Progress",
      description: "Watch your knowledge grow with detailed analytics and achievements.",
    },
  ];
            ...
            <div className="grid md:grid-cols-2 gap-x-12 gap-y-10">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <div className={`space-y-2 ${index % 2 === 1 ? "md:text-right" : ""}`}>
                    <h3 className="font-bold text-xl font-headline">{step.title}</h3>
